...
#include <Windows.h>
#include <string.h>
#define Student_ID "2111041019"
#define Student_name "刘佩佩"
#define Student_class "工程审计(本）2101班"
#define Student_specialized "工程审计"
...
void chinese_test(void)
{
    ...
    printf("1:红楼梦    2:聊斋志异    3:狂人日记    4:三国志\n");
    printf("输入你的选择：");
    scanf("%d", &choice);
    answer = 1;
    if (choice == answer)
